...
from .swarmacb_isaac_marl_env_cfg import SwarmacbIsaacMarlEnvCfg


class SwarmacbIsaacMarlEnv(DirectMARLEnv):
    cfg: SwarmacbIsaacMarlEnvCfg

    def __init__(self, cfg: SwarmacbIsaacMarlEnvCfg, render_mode: str | None = None, **kwargs):
