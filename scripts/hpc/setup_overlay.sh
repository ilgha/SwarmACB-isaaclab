...
echo ""
echo "Or submit one 10-run array:"
echo "  sbatch scripts/hpc/train_dandelion.slurm"
echo "  sbatch scripts/hpc/train_daisy.slurm"
echo "  sbatch scripts/hpc/train_lily.slurm"
echo "  sbatch scripts/hpc/train_tulip.slurm"
echo "  sbatch scripts/hpc/train_cyclamen.slurm"
