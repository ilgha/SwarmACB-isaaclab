...
echo "  bash scripts/hpc/submit_all_dirgate.sh"
echo "  bash scripts/hpc/submit_all_swarmacb.sh"
echo ""
echo "Or submit one Directional Gate 10-run array:"
echo "  sbatch scripts/hpc/train_dirgate_dandelion.slurm"
echo "  sbatch scripts/hpc/train_dirgate_daisy.slurm"
echo "  sbatch scripts/hpc/train_dirgate_lily.slurm"
echo "  sbatch scripts/hpc/train_dirgate_tulip.slurm"
echo "  sbatch scripts/hpc/train_dirgate_cyclamen.slurm"
